...
import net.runelite.client.plugins.microbot.nirifighter.combat.SlayerScript;
...
import java.awt.*;
@Slf4j
public class NiriFighterInfoOverlay extends OverlayPanel {
    private final NiriFighterConfig config;
    public final ButtonComponent myButton;
    public final ButtonComponent blacklistButton;

    @Inject
    NiriFighterInfoOverlay(NiriFighterPlugin plugin, NiriFighterConfig config) {
        super(plugin);
        this.config = config;
    ...
    public Dimension render(Graphics2D graphics) {
        try {
            ...
            panelComponent.getChildren().add(LineComponent.builder()
                    ...
                    .right("Version:" +  NiriFighterPlugin.version)
                    .build());

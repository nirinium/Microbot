package net.runelite.client.plugins.microbot.nirifighter.skill;
...
public class AttackStyleScript extends Script {
    ...
    private void scheduledTask(NiriFighterConfig config) {
        try {
    ...
    private void changeAttackStyle(NiriFighterConfig config, WidgetInfo attackStyleWidgetInfo) {
    ...
    private void selectSkills(NiriFighterConfig config) {
    ...
    private WidgetInfo getComponentToDisplay(NiriFighterConfig config) {

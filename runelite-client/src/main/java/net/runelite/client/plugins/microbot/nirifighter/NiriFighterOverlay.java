...
import net.runelite.client.plugins.microbot.nirifighter.combat.AttackNpcScript;
import net.runelite.client.plugins.microbot.nirifighter.model.Monster;
...
import static net.runelite.client.plugins.microbot.nirifighter.combat.AttackNpcScript.filteredAttackableNpcs;
import static net.runelite.client.plugins.microbot.nirifighter.combat.FlickerScript.currentMonstersAttackingUsRef;
import static net.runelite.client.ui.overlay.OverlayUtil.renderPolygon;

public class NiriFighterOverlay extends OverlayPanel {
    ...
    @Inject
    private NiriFighterOverlay(ModelOutlineRenderer modelOutlineRenderer, NiriFighterConfig config) {

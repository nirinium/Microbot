package net.runelite.client.plugins.microbot.nirifighter.model;
...
public class InventorySetupUtil {
    public static NiriFighterConfig config;
    
    @Inject
    public InventorySetupUtil(NiriFighterConfig config) {
    ...
    public static void determineInventorySetup(String monsterName) {
        ...
        if (!Collections.disjoint(requiredSet, dragonWyvernItems)) {
            ...
            NiriFighterPlugin.setCurrentSlayerInventorySetup(config.dragonWyvernInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, drakeItems)) {
            ...
            NiriFighterPlugin.setCurrentSlayerInventorySetup(config.drakeInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, kuraskTurothItems)) {
            ...
            NiriFighterPlugin.setCurrentSlayerInventorySetup(config.kuraskTurothInventorySetup());
            return;
        }
        if (!Collections.disjoint(requiredSet, caveMiscItems)) {
            ...
            NiriFighterPlugin.setCurrentSlayerInventorySetup(config.caveMiscellaneousInventorySetup());
            return;
        }

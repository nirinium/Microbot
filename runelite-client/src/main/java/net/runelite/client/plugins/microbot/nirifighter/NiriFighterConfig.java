...
import net.runelite.client.plugins.microbot.nirifighter.enums.DefaultLooterStyle;
import net.runelite.client.plugins.microbot.nirifighter.enums.PlayStyle;
...
@ConfigGroup(NiriFighterConfig.GROUP)
...
public interface NiriFighterConfig extends Config {

    String GROUP = "nirifighter";
